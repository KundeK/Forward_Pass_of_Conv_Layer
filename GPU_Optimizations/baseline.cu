...
__global__ void conv_forward_kernel(float *output, const float *input, const float *mask, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K)
{
    ...
    */
    ...
    (void)Height_out; // silence declared but never referenced warning. remove this line when working
    (void)Width_out; // silence declared but never referenced warning. remove this line when working
